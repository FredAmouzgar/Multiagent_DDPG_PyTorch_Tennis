...
class Agent():
    ...
    def load_brain(self, agent_prefix="ag_1", actor_file='checkpoint_actor.pth', critic_file='checkpoint_critic.pth'):
        self.actor_local.load_state_dict(torch.load(agent_prefix + "_" + actor_file))
        self.critic_local.load_state_dict(torch.load(agent_prefix + "_" + critic_file))
